...
<div class="contenido-opticita">
    <div class="titulos-opticita">
        <h2 class="TITULO_OPTICITA">Crea tu Proveedor Ahora</h2>
        <p class="crea-cuenta">Tu informacion es importante actualizala</p>
    </div>
<div class="container-formulario">
        <form action="RespuestaCrearProveedor.php" method="post">
            ...
            <button type="submit" class="btn_btn-primary">Crear Proveedor</button>
        </form>
