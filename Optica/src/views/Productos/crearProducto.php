...
<div class="contenido-opticita">
    <div class="titulos-opticita">
        <h2 class="TITULO_OPTICITA">Crea tu Producto Ahora</h2>
        <p class="crea-cuenta">Tu informacion es importante actualizala</p>
    </div>
<div class="container-formulario">
        <form action="RespuestaCrearProducto.php" method="post">
            ...
            <button type="submit" class="btn_btn-primary">Crear producto</button>
        </form>
